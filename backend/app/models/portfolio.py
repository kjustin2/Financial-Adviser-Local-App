...
from sqlalchemy import Column, String, Text, Integer, ForeignKey, JSON, Numeric, Enum as SQLEnum
...
class Portfolio(BaseModel):
    ...
    rebalance_frequency = Column(SQLEnum(RebalanceFrequency), default=RebalanceFrequency.QUARTERLY)
