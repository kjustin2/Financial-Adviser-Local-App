...
from sqlalchemy import Column, String, Integer, ForeignKey, Numeric, Date, Text, Boolean, Enum as SQLEnum
...
class Transaction(BaseModel):
    ...
    def is_sale(self) -> bool:
        ...
        return self.transaction_type in [TransactionType.SELL, TransactionType.WITHDRAWAL]
    
    @property
    def is_income(self) -> bool:
        """Check if transaction is income (dividend/interest)."""
        return self.transaction_type in [TransactionType.DIVIDEND, TransactionType.INTEREST]
