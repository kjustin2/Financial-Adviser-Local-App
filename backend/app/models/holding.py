...
from sqlalchemy import Column, String, Integer, ForeignKey, Numeric, Date, DateTime, Enum as SQLEnum, UniqueConstraint
...
class Holding(BaseModel):
    ...
    __table_args__ = (
        UniqueConstraint('portfolio_id', 'symbol', 'purchase_date', name='_portfolio_symbol_date_uc'),
    )
