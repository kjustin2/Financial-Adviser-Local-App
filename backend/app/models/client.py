...
from sqlalchemy import Column, String, Date, Integer, ForeignKey, Text, Enum as SQLEnum, Numeric
...
class Client(BaseModel):
    ...
    financial_goals = relationship("FinancialGoal", back_populates="client", cascade="all, delete-orphan")
