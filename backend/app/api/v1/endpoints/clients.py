...
@router.post("/", response_model=StandardResponse[ClientResponse], status_code=status.HTTP_201_CREATED)
def create_client(
    ...
    return StandardResponse(
        data=ClientResponse.from_orm(db_client),
...
def list_clients(
    ...
    for client in clients:
        ...
        total_portfolio_value = sum(
            portfolio.total_value for portfolio in client.portfolios
...
def update_client(
    ...
    return StandardResponse(
        data=ClientResponse.from_orm(client),
